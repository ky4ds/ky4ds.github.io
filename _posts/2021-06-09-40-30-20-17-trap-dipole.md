...
3. **Calculate trap inductance, $$L$$ in Henries.**
...
6. **Revise capacitance based on what can be sourced.** We can roll our
    ...
    * Parallel silver mica capacitors. I haven't tried this, but it
      ...
      voltage rating and one third the capacitance of each capacitor.
        * At $1.78 each, 6 capacitors for a pair of traps will cost
...
* $${Dim_B} = 66\%$$<br />
    ...
    * traps will be located at the end of the 10m section:
        ...
        \\( {Dim_B} = \frac {\text{trap location}} {Dim_A} = \frac {10m} {15m} = 0.\overline{66} \\)
* $$X_L = 600Ω$$<br />
    * as per K1PLP's chart
* $${L_{initial}} = \frac {X_L} {2πf} = \frac {600Ω} {2π28.85Mhz} = 3.310μH$$<br />
* $${C_{initial}} = \frac {1} {(2πf)^2L} = \frac {1} {(2π28.85MHz)^2 3.310μH} = 9.72pF $$<br />
* \\({C_{sourcable}} = 10pF\\)
    * as per Ebay search for [K15Y capacitors][ebay]
* $${L_{revised}} = \frac {1} {(2πf)^2C} = \frac {1} {(2π28.85MHz)^2
  10pF} = 3.043μH$$<br />
...
* $${Dim_B}$$ would be 83%
    ...
    * The second pair of traps will be located at the end of the 20m
      section
        ...
        \\( {Dim_B} = \frac {\text{trap location}} {Dim_A} =\frac {20m} {24m} = 0.8\overline{3} \\)
* $$X_L = 875Ω$$<br />
    * as per K1PLP's chart
* Calculate \\(L\\) and \\(C\\)
