...
3. **Calculate trap inductance $$L$$.** Calculate $$L$$ given $$X_L$$
   ...
   in this case). The formula relating inductive reactance and
   capacitive reactice is:
...
6. **Calculate trap capacitance.** We will take the inductive loading
...
7. **Revise capacitance based on what can be sourced.** We can roll our
...
8. **Recalculate inductance based on the sourcable capacitance.**
